                    ...
                    <form action="joinSave.php" name="join" method="post" onsubmit="return joinChecks()">
                        ...
                        <div class="join__box">
                                <div>
                                    ...
                                    <input type="text" id="youName" name="youName" placeholder="이름을 입력해주세요!" maxlength="5" autocomplete="off" required>
                                ...
                                <div>
                                    <div class="email_C">
                                        ...
                                        <input class="input__width" type="email" id="youEmail" name="youEmail" maxlength="20" placeholder="이메일을 입력해주세요!" autocomplete="off" required>
                                ...
                                <div>
                                    ...
                                    <input type="password" id="youPassC" name="youPassC" placeholder="확인 비밀번호를 입력해주세요!" autocomplete="off" required>
                                    <p class="msg" id="youPassCComment"><!--* 비밀번호가 일치하지 않습니다.--></p>
                                </div>
                                <div>
                                    <label for="youPhone">*전화번호</label>
                                    <input type="text" id="youPhone" name="youPhone" placeholder="휴대폰번호를 입력해주세요!" maxlength="15" autocomplete="off" required>
